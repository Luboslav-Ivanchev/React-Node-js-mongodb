                    ...
                    <div className="footer-content">
                            ...
                            <div className="footer-menu">
                                ...
                                <ul id="menu-company" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="/loggedIn/contactWithUs ">Contact</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="footer-menu">
                        ...
                        <div className="footer-content-column">
                            <div className="footer-call-to-action">
                                ...
                                <a className="footer-call-to-action-button button" href="/loggedIn/contactWithUs " target="_self"> Get in Touch </a>
                            </div>
                            <div className="footer-call-to-action">
                                <h2 className="footer-call-to-action-title"> You Call Us</h2>
                                <p className="footer-call-to-action-link-wrapper"><a className="footer-call-to-action-link"
                                                                                     href="tel:0124-64XXXX"
                                                                                     target="_self"> 0124-64XXXX </a></p>
                            </div>
                        </div>
                    ...
                    <div className="footer-content">
                        ...
                        <div className="footer-content-column">
                            <div className="footer-menu">
                                ...
                                <ul id="menu-company" className="footer-menu-list">
                                    <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                        <a href="/contactWithUs">Contact</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="footer-menu">
                        ...
                        <div className="footer-content-column">
                            <div className="footer-call-to-action">
                                <h2 className="footer-call-to-action-title"> Let's Chat</h2>
                                <p className="footer-call-to-action-description"> Have a support question?</p>
                                <a className="footer-call-to-action-button button" href="/contactWithUs" target="_self"> Get in Touch </a>
                            </div>
                            <div className="footer-call-to-action">
                                <h2 className="footer-call-to-action-title"> You Call Us</h2>
                                <p className="footer-call-to-action-link-wrapper"><a className="footer-call-to-action-link"
